...
CREATE TABLE pawn_tickets (
  ...
  status ENUM('ACTIVE','RENEWED','OVERDUE','CLOSED','AUCTION','REVERSED') NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE ticket_status_history (
  ...
  ticket_id BIGINT NOT NULL,
  old_status ENUM('ACTIVE','RENEWED','OVERDUE','CLOSED','AUCTION','REVERSED') NOT NULL,
  new_status ENUM('ACTIVE','RENEWED','OVERDUE','CLOSED','AUCTION','REVERSED') NOT NULL,
